...
export interface IReporteMovimientosContablesAgrupadosRepository {
  /**
   * Obtiene el reporte de movimientos contables agrupados por NIT y dimensión contable
  ...
  /**
   * Obtiene estadísticas del reporte (totales, subtotales)
   * @param filtros Filtros para el reporte
