...
/**
 * Interfaz del repositorio para Balance de Comprobación
 * Define los contratos para el acceso a datos del reporte de Balance de Comprobación
 */
export interface IBalanceComprobacionRepository {
  /**
