...
// Endpoint optimizado con paginación para evitar respuestas muy grandes
app.post('/api/saldo-promedios/:conjunto/generar-optimizado', (req, res) => {
  const { conjunto } = req.params;
  const { page = 1, limit = 100, fecha_desde, fecha_hasta, saldosAntesCierre } = req.body;
  
  console.log('📊 Endpoint optimizado llamado con:', { conjunto, page, limit, fecha_desde, fecha_hasta, saldosAntesCierre });
  
  // Simular datos paginados (en producción esto vendría de la base de datos)
  const totalRegistros = 66241;
  const registrosPorPagina = parseInt(limit);
  const paginaActual = parseInt(page);
  const offset = (paginaActual - 1) * registrosPorPagina;
  
  // Generar datos de ejemplo para la página solicitada
  const datosPagina = [];
  const registrosEnPagina = Math.min(registrosPorPagina, totalRegistros - offset);
  
  for (let i = 0; i < registrosEnPagina; i++) {
    const indiceGlobal = offset + i;
    datosPagina.push({
      centro_costo: `CC${String(indiceGlobal + 1).padStart(3, '0')}`,
      cuenta_contable: `01.${Math.floor(indiceGlobal / 1000)}.${Math.floor(indiceGlobal / 100)}.${Math.floor(indiceGlobal / 10)}.${String(indiceGlobal % 10).padStart(3, '0')}`,
      descripcion: `Cuenta ${indiceGlobal + 1}`,
      saldo_inicial_local: Math.round((Math.random() * 100000 + 1000) * 100) / 100,
      saldo_inicial_dolar: Math.round((Math.random() * 10000 + 100) * 100) / 100,
      saldo_inicial_corp_local: Math.round((Math.random() * 100000 + 1000) * 100) / 100,
      saldo_inicial_corp_dolar: Math.round((Math.random() * 10000 + 100) * 100) / 100,
      saldo_inicial_fisc_und: Math.round((Math.random() * 1000 + 10) * 100) / 100,
      saldo_inicial_corp_und: Math.round((Math.random() * 1000 + 10) * 100) / 100,
      debito_fisc_local: Math.round((Math.random() * 50000 + 500) * 100) / 100,
      credito_fisc_local: Math.round((Math.random() * 30000 + 300) * 100) / 100,
      debito_fisc_dolar: Math.round((Math.random() * 5000 + 50) * 100) / 100,
      credito_fisc_dolar: Math.round((Math.random() * 3000 + 30) * 100) / 100,
      debito_corp_local: Math.round((Math.random() * 50000 + 500) * 100) / 100,
      credito_corp_local: Math.round((Math.random() * 30000 + 300) * 100) / 100,
      debito_corp_dolar: Math.round((Math.random() * 5000 + 50) * 100) / 100,
      credito_corp_dolar: Math.round((Math.random() * 3000 + 30) * 100) / 100,
      debito_fisc_und: Math.round((Math.random() * 500 + 5) * 100) / 100,
      credito_fisc_und: Math.round((Math.random() * 300 + 3) * 100) / 100,
      debito_corp_und: Math.round((Math.random() * 500 + 5) * 100) / 100,
      credito_corp_und: Math.round((Math.random() * 300 + 3) * 100) / 100,
      saldo_final_local: Math.round((Math.random() * 120000 + 1200) * 100) / 100,
      saldo_final_dolar: Math.round((Math.random() * 12000 + 120) * 100) / 100,
      saldo_final_corp_local: Math.round((Math.random() * 120000 + 1200) * 100) / 100,
      saldo_final_corp_dolar: Math.round((Math.random() * 12000 + 120) * 100) / 100,
      saldo_final_fisc_und: Math.round((Math.random() * 1200 + 12) * 100) / 100,
      saldo_final_corp_und: Math.round((Math.random() * 1200 + 12) * 100) / 100,
      saldo_promedio_local: Math.round((Math.random() * 110000 + 1100) * 100) / 100,
      saldo_promedio_dolar: Math.round((Math.random() * 11000 + 110) * 100) / 100,
      saldo_promedio_corp_local: Math.round((Math.random() * 110000 + 1100) * 100) / 100,
      saldo_promedio_corp_dolar: Math.round((Math.random() * 11000 + 110) * 100) / 100,
      saldo_promedio_fisc_und: Math.round((Math.random() * 1100 + 11) * 100) / 100,
      saldo_promedio_corp_und: Math.round((Math.random() * 1100 + 11) * 100) / 100
    });
  }
